...
这不是我创建的项目，它是 [HenCoder Android 开发进阶：UI 1-1 绘制基础](http://hencoder.com/ui-1-1) 的配套练习项目。[这是原项目的地址](https://github.com/hencoder/PracticeDraw1)

但是这是几年前的项目，Android 也更新了很多版本，androidx 代替了 support, 同时 Kotlin 也逐渐成为主流。因此，这个项目是我使用最新的 Android Studio 4.0 以及 Kotlin 进行重构的。项目的结构和原先没有太大差距。
